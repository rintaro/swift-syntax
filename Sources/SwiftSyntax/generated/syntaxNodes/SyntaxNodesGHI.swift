...
public struct GenericArgumentClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public func addArgument(_ element: GenericArgumentListSyntax.Element) -> GenericArgumentClauseSyntax {
    var node = self
...
public struct GenericParameterClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public func addParameter(_ element: GenericParameterListSyntax.Element) -> GenericParameterClauseSyntax {
    var node = self
...
public struct GenericParameterSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public func addAttribute(_ element: AttributeListSyntax.Element) -> GenericParameterSyntax {
    var node = self
...
public struct GenericWhereClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public func addRequirement(_ element: GenericRequirementListSyntax.Element) -> GenericWhereClauseSyntax {
    var node = self
    node.requirements.append(element)
    return node
  }
...
public struct GuardStmtSyntax: StmtSyntaxProtocol, SyntaxHashable, _LeafStmtSyntaxNodeProtocol {
  ...
  public func addCondition(_ element: ConditionElementListSyntax.Element) -> GuardStmtSyntax {
    var node = self
...
public struct IfConfigDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public func addClause(_ element: IfConfigClauseListSyntax.Element) -> IfConfigDeclSyntax {
    var node = self
    node.clauses.append(element)
    return node
  }
...
public struct IfExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  ///            appended to its `conditions` collection.
  @available(*, deprecated, message: "Use node.conditions.append(newElement) instead")
  public func addCondition(_ element: ConditionElementListSyntax.Element) -> IfExprSyntax {
    var node = self
    node.conditions.append(element)
    return node
  }
...
public struct ImportDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  ///            appended to its `attributes` collection.
  @available(*, deprecated, message: "Use node.attributes.append(newElement) instead")
  public func addAttribute(_ element: AttributeListSyntax.Element) -> ImportDeclSyntax {
    var node = self
    node.attributes.append(element)
    return node
  }
  ...
  public func addModifier(_ element: DeclModifierListSyntax.Element) -> ImportDeclSyntax {
    var node = self
  ...
  public func addPathComponent(_ element: ImportPathComponentListSyntax.Element) -> ImportDeclSyntax {
    var node = self
...
public struct InheritanceClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public func addInheritedType(_ element: InheritedTypeListSyntax.Element) -> InheritanceClauseSyntax {
    var node = self
    node.inheritedTypes.append(element)
    return node
  }
...
public struct InitializerDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  ///            appended to its `attributes` collection.
  @available(*, deprecated, message: "Use node.attributes.append(newElement) instead")
  public func addAttribute(_ element: AttributeListSyntax.Element) -> InitializerDeclSyntax {
    var node = self
    node.attributes.append(element)
    return node
  }
  ...
  ///            appended to its `modifiers` collection.
  @available(*, deprecated, message: "Use node.modifiers.append(newElement) instead")
  public func addModifier(_ element: DeclModifierListSyntax.Element) -> InitializerDeclSyntax {
    var node = self
    node.modifiers.append(element)
    return node
  }
