...
/// Returns the underlying syntax node type.
  var syntaxNodeType: SyntaxProtocol.Type {
    ...
    case .decl: return DeclSyntax.self
    case .expr: return ExprSyntax.self
    case .stmt: return StmtSyntax.self
    case .type: return TypeSyntax.self
    case .pattern: return PatternSyntax.self
