...
public struct EnumCaseElementSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((RawSyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        ...
        rawValue?.raw,
        unexpectedBetweenRawValueAndAccessorBlock?.raw,
        accessorBlock?.raw,
  ...
  public var unexpectedBetweenRawValueAndAccessorBlock: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  public var trailingComma: TokenSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 9, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EnumCaseElementSyntax.self)
    }
  }
  ...
  public var unexpectedAfterTrailingComma: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 10, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(EnumCaseElementSyntax.self)
    }
  }
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.rawValue,
    \Self.unexpectedBetweenRawValueAndAccessorBlock,
    \Self.accessorBlock,
